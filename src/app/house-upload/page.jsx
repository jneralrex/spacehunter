    ...
    <main className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 overflow-x-hidden selection:bg-blue-100 dark:selection:bg-blue-900 selection:text-blue-900 dark:selection:text-blue-100">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 pt-24 pb-16">
        <MaxWidthWrapper>
          <div className="relative z-10 max-w-4xl mx-auto text-center">
            ...
            >
              List your apartment, office, or event space in minutes — 
              <strong className="text-slate-900 font-semibold"> verified renters, guaranteed income.</strong>
            </motion.p>
      ...
      <section className="py-16 px-6">
        <MaxWidthWrapper>
          ...
          >
            {[
              { num: "5K+", label: "Active Listings" },
              { num: "98%", label: "Listing Success Rate" },
              { num: "24 Hours", label: "Avg. Time to First Inquiry" },
            ].map((s, i) => (
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-black leading-tight mb-6">
                Built for landlords who want <span className="text-blue-600">peace of mind.</span>
              </h2>
              <p className="text-lg text-slate-600 leading-relaxed">
                We handle the vetting, payments, and compliance — you just earn money.
              </p>
            </motion.div>
        ...
        <MaxWidthWrapper>
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-black leading-tight">
              Three steps to <span className="text-blue-600">earn money.</span>
            </h2>
          </motion.div>
      ...
      <section className="py-24 px-6">
        <MaxWidthWrapper>
          <motion.div
            ...
            className="text-center mb-16"
          >
            <p className="text-xs font-bold tracking-widest text-blue-600 uppercase mb-3">Success Stories</p>
            <h2 className="text-4xl md:text-5xl font-black leading-tight">
              What <span className="text-blue-600">property owners</span> say
            </h2>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-5xl md:text-6xl font-black leading-tight mb-6">
                Start <span className="text-blue-200">earning</span> today.
              </h2>
              <p className="text-lg text-blue-100 max-width mx-auto mb-10 leading-relaxed max-w-2xl">
                List your property in minutes. Connect with qualified tenants. Earn consistent income with SpaceHunter.
              </p>
